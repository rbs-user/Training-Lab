        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="text"
                className={`p-2 border w-[90%] my-2 rounded shadow-xl ${errors.name ? 'border-red-500 outline-none' : 'border-gray-500 outline-blue-500'}`}
                {...register('name')}
              />
              {errors.name && (
            ...
            <div>
              ...
              <input
                type="email"
                className={`p-2 border w-[90%] my-2 rounded shadow-xl ${errors.email ? 'border-red-500 outline-none' : 'border-gray-500 outline-blue-500'}`}
                {...register('email')}
              />
              {errors.email && (
            ...
            <div>
              ...
              <input
                type="password"
                className={`p-2 border w-[90%] my-2 rounded shadow-xl ${errors.password ? 'border-red-500 outline-none' : 'border-gray-500 outline-blue-500'}`}
                {...register('password')}
              />
              {errors.password && (
            ...
            <div>
              ...
              <input
                type="number"
                className={`p-2 border w-[90%] my-2 rounded shadow-xl ${errors.phoneNumber ? 'border-red-500 outline-none' : 'border-gray-500 outline-blue-500'}`}
